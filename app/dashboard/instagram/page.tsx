                ...
                return (
                  <div key={automation.id} className="space-y-2">
                    {automation.id === "instagram" ? (
                      ...
                      <Link href={automation.id === "gmail" ? "/dashboard/gmail" : automation.id === "inventory" ? "/dashboard/inventory" : "/dashboard"}>
          ...
          <div className="px-4 sm:px-6 lg:px-8">
            <div className="flex justify-between items-center h-16">
              <div className="flex items-center space-x-4">
                ...
                <h1 className="text-xl font-semibold">Instagram Automation</h1>
              </div>
