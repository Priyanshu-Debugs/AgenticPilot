    ...
    <div className="p-4 sm:p-6 space-y-4 sm:space-y-6 max-w-7xl mx-auto">
      ...
      <details className="group border border-border bg-card rounded-lg p-4 [&_summary::-webkit-details-marker]:hidden">
        ...
        <div className="mt-4 text-sm text-muted-foreground space-y-2 pl-6 border-l-2 border-primary/20 ml-2">
          ...
          <p>
            4. Enable{" "}
            <strong className="text-foreground">Background Automation</strong>{" "}
            to have AI scan and draft replies every 5 minutes without opening
            the site.
          </p>
          <p>
            5. Review drafted responses or use the{" "}
            <strong className="text-foreground">Analyze</strong> feature for
            single emails.
          </p>
        </div>
      </details>
      ...
      {isConnected && (
        <Tabs defaultValue="inbox" className="space-y-4">
          ...
          <TabsContent value="activity">
            <ActivityLog logs={logs} stats={stats} loading={logsLoading} />
          </TabsContent>
        </Tabs>
      )}
        ...
        <Card className="border-dashed">
          <CardContent className="py-8 sm:py-12 px-4 sm:px-6 text-center">
            ...
            <p className="text-sm sm:text-base text-muted-foreground max-w-md mx-auto">
              Connect your Gmail account to start using AI-powered email
              automation. Analyze emails, generate intelligent responses, and
              save time.
            </p>
          </CardContent>
        </Card>
