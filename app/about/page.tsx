            ...
            {founders.map((founder, index) => (
              ...
              >
                <SpotlightCard className="h-full flex flex-col p-6 items-center text-center">
                  <div className="size-20 rounded-full bg-gradient-to-br from-primary/20 to-accent/20 p-[2px] mb-6">
                    <img
                      src={founder.avatar}
                  ...
                  <div className="mt-auto pt-4 w-full flex justify-center gap-x-4 border-t border-border/30">
                    <a
                      href={founder.github}
                      target="_blank"
          ...
          >
            <SpotlightCard className="p-8 md:p-12 border-primary/20 bg-primary/5">
              <div className="flex flex-col md:flex-row items-center gap-8">
                <div className="size-16 shrink-0 rounded-2xl bg-primary/20 flex items-center justify-center">
